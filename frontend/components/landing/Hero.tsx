...
const Hero: React.FunctionComponent<IHeroProps> = (props) => {
  return (
    ...
    {/* Subtitle */}
            <p className="text-lg text-center text-gray-300 max-w-4xl mb-8">Financial data and analytics platform that provides investors with the tools and insights they need to make informed investment decisions.</p>
    {/* Button Wrapper */}
